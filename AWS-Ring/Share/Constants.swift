...
struct Constant {
    ...
    struct ASWConfiguration {
        #if DEBUG
        static let snsPlatformApplicationArn = ""
        #else
        static let snsPlatformApplicationArn = ""
        #endif

        struct CredentialsProvider {
            static let accessKey = "YOUR ACCESS KEY ID"
            static let secretKey = "YOUR SECRET KEY"
        }

        struct S3 {
            static let facesBucketName = "ring-faces"
        }
    }
    
    static let globalDateFormat = "yyyy-MM-dd'T'HH:mm:ss.sssZ"
    static let awsRekognitionCollectionId = "RingCollection"
